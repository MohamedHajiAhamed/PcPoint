...
namespace PcPoint
{
    public partial class Payment_employee : Form
    {
        public Payment_employee(DataTable data, int invoice_no, string user_id, Image img)
        {
            InitializeComponent();
        ...
        private void btn_print_Click(object sender, EventArgs e)
        {
            ...
            PaperSize paperSize = new PaperSize("Custom", 827, 869);
