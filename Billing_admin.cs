...
namespace PcPoint
{
    public partial class Billing_admin : Form
    {
        public Billing_admin(string user_id, Image img)
        {
            InitializeComponent();
        ...
        private void btn_maximize_Click(object sender, EventArgs e)
        {
            if (WindowState == FormWindowState.Normal)
            {
                ...
                dataGridView1.Size = new System.Drawing.Size(600, 450);
                dataGridView1.Location = new Point(83, 279);
                lbl_datagridview1.Location = new Point(320, 246);
                dataGridView2.Size = new System.Drawing.Size(600, 450);
                dataGridView2.Location = new Point(738, 279);
                lbl_datagridview2.Location = new Point(1000, 246);

            }
            else
            {
                WindowState = FormWindowState.Normal;
                dataGridView1.Size = new System.Drawing.Size(509, 422);
                dataGridView1.Location = new Point(93, 269);
                lbl_datagridview1.Location = new Point(279, 236);
                dataGridView2.Size = new System.Drawing.Size(509, 422);
                dataGridView2.Location = new Point(643, 269);
                lbl_datagridview2.Location = new Point(842, 236);
            }
        }
        ...
        private void Billing_admin_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void txtbox_quantity_TextChanged_1(object sender, EventArgs e)
        {
            UpdateTotalPrice();
        }
